    ...
    'inline-flex items-center gap-2 justify-center font-medium whitespace-nowrap rounded-xl transition-colors focus-visible:outline-none [&>svg]:text-muted-foreground disabled:opacity-70',
    {
        variants: {
            variant: {
                ...
                primary: 'bg-primary text-background font-semibold hover:opacity-90 [&>svg]:text-background',
                'primary-secondary':
                    'bg-primary-secondary text-primary-secondary-foreground font-semibold hover:opacity-90',
                accent: 'text-primary bg-yellow-100 hover:bg-yellow-200 font-semibold',
                ...
                secondary:
                    'bg-surface dark:border dark:border-border-strong text-muted-foreground opacity-100 hover:opacity-80 [&>svg]:text-muted-foreground font-semibold',
                ghost: 'hover:bg-surface-hover text-muted-foreground opacity-100 hover:text-foreground',
                'ghost-bordered':
