...
export enum ModelEnum {
    ...
    O4_Mini = 'o4-mini',
    GEMINI_2_FLASH = 'gemini-2.5-flash-preview-09-2025',
...
export const supportsThinkingReasoning = (mode?: string): boolean => {
    // O1 models (like O4_Mini) support thinking/reasoning tokens
    return mode === ChatMode.O4_Mini;
};
