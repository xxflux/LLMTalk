...
import { useImageAttachment } from '@/common/hooks';
import { ChatModeConfig } from '@/shared/config';
import { cn, Flex } from '@/common/ui';
import { AnimatePresence, motion } from 'framer-motion';
import { useParams, usePathname, useRouter } from 'next/navigation';
import React, { useEffect } from 'react';
import { v4 as uuidv4 } from 'uuid';
import { useShallow } from 'zustand/react/shallow';
import { useAgentStream } from '../../hooks/agent-context-provider';
import { useChatEditor } from '../../hooks/use-chat-editor-hook';
import { useChatStore } from '../../store';
import { ExamplePrompts } from '../example-prompts-component';
import { ChatModeButton, GeneratingStatus, SendStopButton, WebSearchButton } from './chat-actions-component';
import { ChatEditor } from './chat-editor-component';
import { ImageUpload } from './chat-image-upload';
        ...
        <AnimatePresence>
            ...
            >
                <Flex
                    direction="col"
                    className={cn(
                        'bg-background border-border-strong/50 shadow-subtle-sm relative z-10 w-full rounded-xl border'
                    )}
                >
