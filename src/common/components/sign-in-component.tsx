// Auth removed - Clerk sign-in component no longer used
        ...
        return (
            <div className="flex w-[300px] flex-col items-center gap-4">
                <div className="flex flex-col items-center gap-1">
                    <h2 className="font-clash text-foreground !text-primary text-center text-[24px] font-semibold leading-tight">
                        Check your email
                    </h2>
                ...
                <p className="text-muted-foreground text-center text-sm">
                    ...
                    <span
                        className={`hover:text-primary text-primary cursor-pointer underline ${
                ...
                <div className="text-muted-foreground text-center text-sm">
                    ...
                    {resending && <p className="text-primary">Sending verification code...</p>}
                </div>
            </div>
        );
    }
