...
import { HoverCard, HoverCardContent, HoverCardTrigger } from '@/common/ui';
import { IconExternalLink } from '@tabler/icons-react';
import React, { memo, useState } from 'react';
import { LinkFavicon } from './link-favicon-component';
...
export const LinkPreviewPopover = memo(({ source, children }: LinkPreviewType) => {
    ...
    return (
        <HoverCard openDelay={200} closeDelay={100}>
            ...
            <HoverCardContent
                className="bg-background prose-none hover:border-border-strong group isolate z-[100] w-[400px] cursor-pointer rounded-xl p-0 shadow-2xl"
                onClick={e => {
                    e.stopPropagation();
                    e.preventDefault();
            ...
            >
                <IconExternalLink
                    className="text-muted-foreground group-hover:text-primary absolute right-3 top-3"
                    size={14}
                />
