import { LinkFavicon, SourceList } from '@/common/components';
        ...
        <div className="grid grid-cols-4 gap-2 pb-8 pt-2">
            {sortedSources.slice(0, 3).map((source, index) => (
                <div
                    ...
                    className="bg-surface-hover/60 hover:bg-surface-hover flex cursor-pointer flex-col justify-between rounded-md p-2"
                >
                    {source?.link && (
            ...
            {sources.length > 3 && (
                <div
                    key={4}
                    className="bg-surface-hover/60 hover:bg-surface-hover flex cursor-pointer flex-col items-start gap-1 rounded-md p-2"
                    onClick={() => {
                        openSideDrawer({
                            title: 'Sources',
