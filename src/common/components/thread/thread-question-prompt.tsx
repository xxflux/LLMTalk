import { useAgentStream } from '@/common/hooks';
import { useChatStore } from '@/common/store';
import { ThreadItem } from '@/shared/types';
import { Button, RadioGroup, RadioGroupItem, Textarea } from '@/common/ui';
                ...
                {options.map((option, index) => (
                    ...
                    >
                        {selectedOptions.includes(option) ? (
                            <IconCheck size={16} strokeWidth={2} className="text-primary" />
                        ) : (
                            <IconSquare
                                size={16}
                                strokeWidth={2}
    ...
    return (
        <div className="border-border bg-background mt-2 flex w-full flex-col items-start gap-4 rounded-lg border p-4">
            <div className="flex flex-row items-center gap-1">
                <IconQuestionMark size={16} strokeWidth={2} className="text-primary" />
