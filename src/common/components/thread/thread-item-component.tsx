...
import { useAnimatedText } from '@/common/hooks';
import { useChatStore } from '@/common/store';
import { ThreadItem as ThreadItemType } from '@/shared/types';
import { Alert, AlertDescription, cn } from '@/common/ui';
            ...
            <CitationProvider sources={threadItem.sources || []}>
                <div className="w-full" ref={inViewRef} id={`thread-item-${threadItem.id}`}>
                    <div className={cn('flex w-full flex-col items-start gap-3 pt-4')}>
                        ...
                        {(threadItem.answer?.thinking || threadItem.answer?.reasoning) && (
                            <div className="flex w-full flex-col gap-3">
                                {threadItem.answer?.thinking && (
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="text-muted-foreground rounded-lg border border-border bg-muted/30 p-3 text-sm">
