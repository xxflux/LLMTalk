...
import { Badge, Button, Flex, SonnerToaster, Toaster } from '@/common/ui';
...
export const RootLayout: FC<TRootLayout> = ({ children }) => {
    ...
    const containerClass =
        'relative flex flex-1 flex-row h-[calc(100dvh-3.5rem)] border border-border rounded-sm bg-secondary w-full overflow-hidden shadow-sm';

    // For design-system page, render without sidebar and simplified layout
    ...
    return (
        <div className="bg-surface flex h-[100dvh] w-full flex-col overflow-hidden">
            <TopNav />
            <div className="bg-surface item-center fixed inset-0 z-[99999] flex justify-center md:hidden">
            ...
            <div className="bg-surface flex flex-1 flex-row overflow-hidden pt-14">
