...
export const ToolsMenu = () => {
    ...
    const [isToolsAvailable, setIsToolsAvailable] = useState(false);

    useEffect(() => {
        hasApiKeyForChatMode(chatMode).then(setIsToolsAvailable);
